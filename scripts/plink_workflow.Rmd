...
#deletion of the ID's that failed the hetero test
./plink --bfile merge54k_cleaned1_update  --cow --remove hetero_remove --make-bed --out merge54k_update1
./plink --bfile merge777k_cleaned_update --cow --remove hetero_remove --make-bed --out merge777k_update1
./plink --bfile merge54k_affymetrix_update --cow --remove hetero_remove --make-bed --out merge54k_affymetrix_update1
