...
* List of the Snps to check. This list is a 2 columns. The first column is the name of the SNP and the second column is the allele TOP used. You can download the file with this informations from http://bioinformatics.tecnoparco.org/SNPchimp/index.php/download
...
((counter_miss++))
 ...
 echo " The number of correct checked SNPs is $counter SNPs over $counter_total controlled SNPs "
 echo " The percentage of correct counted SNPs is $((100*counter/counter_total))%"
 ...
 echo " the percentage of missing SNPs is  $((100*counter_miss/counter_total))%"
  if [[ $((100*counter/counter_total)) -ge 100 ]] ; then
 echo " All the SNPs checked and the file is in TOP format"
 elif [[ $((100*counter/counter_total)) -ge 95 && $((100*counter/counter_total)) -lt 100 ]] ; then
 ...
 elif [[ $((100*counter/counter_total)) -lt 95 ]] ; then
 echo " This error rate suggests that your file is not a TOP format Illumina file. Contact your laboratory for more info"
 else
 exit
  fi
```
