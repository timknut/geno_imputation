...
ID=$(printf '%s\n' "$line" | awk '{print $1}') #ID contains a single individual
...
echo " Do you want to mask SNPs according to a percentage? 
        1. YES
        2. NO
        "
read answer
